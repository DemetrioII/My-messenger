...
public:
  ...
  std::vector<uint8_t> serialize(Message &&msg) const;
  Message deserialize(std::vector<uint8_t> &&raw) const;
  ~Serializer() = default;
};
...
inline const std::vector<uint8_t> YOU_ARE_LOGGED_IN = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x22, 0x5b, 0x45, 0x72, 0x72,
    0x6f, 0x72, 0x5d, 0x3a, 0x20, 0x59, 0x6f, 0x75, 0x20, 0x61,
    0x72, 0x65, 0x20, 0x61, 0x6c, 0x72, 0x65, 0x61, 0x64, 0x79,
    0x20, 0x6c, 0x6f, 0x67, 0x67, 0x65, 0x64, 0x20, 0x69, 0x6e,
};

inline const std::vector<uint8_t> YOU_ARE_NOT_MEMBER = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x28, 0x5b, 0x45, 0x72, 0x72, 0x6f, 0x72,
    0x5d, 0x3a, 0x20, 0x59, 0x6f, 0x75, 0x20, 0x61, 0x72, 0x65, 0x20, 0x6e,
    0x6f, 0x74, 0x20, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x20, 0x6f, 0x66,
    0x20, 0x74, 0x68, 0x69, 0x73, 0x20, 0x63, 0x68, 0x61, 0x74,
};
